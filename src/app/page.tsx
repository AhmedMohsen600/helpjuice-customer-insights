      ...
      <section id="ideas" className="bg-white px-5 py-20 sm:px-6 md:py-28 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            ...
            description="Start with the product moves that directly answer customer pain: ask questions instead of reading everything, trust AI answers, improve weak documents, and turn feedback into better content."
            level="h1"
          />
      ...
      <section id="competitors" className="px-5 py-20 sm:px-6 md:py-28 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            ...
            description="The useful signal is where products break down: bloat, brittle authoring, opaque pricing, weak portability, and support workflows that do not connect to knowledge work."
          />
