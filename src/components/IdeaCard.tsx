...
export function IdeaCard({ idea, index, featured = false }: IdeaCardProps) {
  return (
    <article
      className={[
        "group rounded-2xl border border-slate-200 bg-white p-6 transition duration-200 hover:border-slate-300 hover:shadow-[0_18px_50px_rgba(15,23,42,0.07)]",
    ...
    >
      ...
      <h3 className="max-w-xl text-2xl font-semibold leading-tight text-slate-950">
        {idea.title}
      </h3>
